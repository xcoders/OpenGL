...
/////////////////////////////////////////////////////////////////
// This method sets the value of the light angle to the
// value obtained from sender
- (IBAction)takeLightPositionFrom:(UISlider *)sender;
{
    // light position components w, x, y, z.
    // to make light directional, set w component 0
    self.baseEffect.light0.position =
    GLKVector4Make( 0.0f, sender.value, 0.5f, 0.0f );
}
